...
public final class KeyPressTypeDemoCommand implements BotCommand {
  private static final Logger logger = LogManager.getLogger(KeyPressTypeDemoCommand.class);
  ...
  public Optional<Value> execute(GlobalSessionContext globalSessionContext,
    ...
    KeyPressTypeDemo command = new KeyPressTypeDemo();
    ...
    try {
      command.typeIn((String)convertedParameters.get("keyPress"));Optional<Value> result = Optional.empty();
      return logger.traceExit(result);
    }
    catch (ClassCastException e) {
      throw new BotCommandException(MESSAGES_GENERIC.getString("generic.IllegalParameters","typeIn"));
    }
